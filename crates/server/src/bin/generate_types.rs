...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::oauth::GoogleVerifyRequest::decl(),
        server::routes::oauth::GoogleVerifyResponse::decl(),
        server::routes::oauth::GoogleSessionResponse::decl(),
        services::services::google_sso::GoogleSsoConfigDto::decl(),
